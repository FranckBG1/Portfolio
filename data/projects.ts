...
export const projects: Project[] = [
  ...
  },
  {
    ...
    context:
      "Built to replace manual notebook-based stock and sales tracking for a small business. The goal was to digitize daily operations and give the owner real-time visibility over inventory and revenue. Livré au client sous version desktop.",
    contribution:
      "Designed and developed the full application end-to-end — data model, REST API, and Angular frontend. Système de rôles : le vendeur accède uniquement aux opérations de vente et de stock du jour, tandis que l'administrateur dispose d'une vue globale — chiffre d'affaires, historique complet des événements, gestion des utilisateurs. Données présentées en démo sont des données de test.",
    result:
      "Eliminated manual tracking errors, reduced reconciliation time, and gave the business owner a clear daily overview of stock levels and sales performance. Produit livré et déployé chez le client.",
